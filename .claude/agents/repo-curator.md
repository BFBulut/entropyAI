...
- Faz 14'ün yeni modülleri kapsam yollarındadır: `src/entropy/agents/ephemeral.py`, `src/entropy/core/pending.py`, `src/entropy/core/permission_server.py`, `src/entropy/brain/agent_memory_writer.py`.
