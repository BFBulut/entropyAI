...
## Çalışma belleğin
İşe başlamadan önce `docs/STATE.md` (varsa) ve `docs/reports` altındaki en son ilerleme raporunu oku; sözleşmeleri (bus sinyalleri, kwarg adları) oradan doğrula. Faz 14 yürürlükte: plan ve dilimler `docs/reports/2026-09-11_Faz14_Analiz_ve_Plan.md` (dayanak: aynı tarihli A ve B araştırma notları), karar [ADR-0010](../../docs/adr/ADR-0010-gecici-ajan-mimarisi-langgraph-alinmadi.md).
