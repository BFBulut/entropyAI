...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'entropy.brain.report_watcher',
        'entropy.brain.handoff',
        'entropy.brain.obsidian.vault_manager',
        'entropy.brain.wiki',
        'entropy.brain.lint',
        ...
        'entropy.brain.graph_enrich',
        'networkx',
        'networkx.algorithms.community',
        'entropy.brain.office_memory',
        'entropy.brain.supabase.cognitive_memory',
        'numpy',
        'entropy.brain.rag.project_indexer',
        'entropy.tools',
